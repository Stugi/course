...
// Примечание от автора: Это один из возможных вариантов решения.
//Вы можете оформить каждую стадию пайплайна в виде структуры одного типа или интерфейса.
//Будет интересно посмотреть на ваш выбор.

// Можно создать кольцевой массив на основе подпакета container/ring,
//связного списка или очереди.
//Можете даже попробовать источник данных и потребителя внести в сам пайплайн таким образом, чтобы они стали такими же полноценными стадиями, но эта задача будет непростой.
